...
class choose(tk.Frame):
    ...
    def create_window(self):     # 條件選擇頁面
        ...
        self.button_sure = tk.Button(self, text = "呈現所有搜尋結果", height = 2, width = 15, font = f1, fg = "Red", command = lambda:[self.checkcmb_1(), self.checkcmb_2(), self.checkcmb_3(), self.change()])
        ...
        self.label_autochs2 = tk.Label(self, text = "給有選擇障礙的你...", height = 3, width = 15, font = f1, fg = "Black")
        self.label_autochs2.grid(row = 13, column = 3,  sticky = tk.W+tk.E) 
        
        self.button_autochs = tk.Button(self, text = "請幫我選一間QQ", height = 2, width = 15, font = f1, fg = "Red", command = lambda:[self.checkcmb_1(), self.checkcmb_2(), self.checkcmb_3(), self.change_autochs()])
...
class result(tk.Frame):
    ...
    def create_window(self):
        ...
        if selected_rst == []:       # 沒有符合條件的餐廳
            ...
            self.Lb1 = tk.Label(self, text = "你可以選擇...", height = 5, width = 50, font = f1, fg = "Blue")
            ...
            self.button_return= tk.Button(self, text="再一次", height = 1, width = 5, font = f2, fg = "Black", command = self.change)
            self.button_return.grid(column = 1, columnspan = 2, sticky = tk.E + tk.W + tk.S)
            self.button_return_f= tk.Button(self, text="結束", height = 1, width = 5, font = f2, fg = "Black", command = self.quit)
    ...
    def add_label(self, text_input, r):   # 生成標籤
        ...
        self.label_add.grid(row = r, column = 1)
        # self.label_add.pack()
